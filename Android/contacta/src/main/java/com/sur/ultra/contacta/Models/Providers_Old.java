 ...
 */
public class Providers_Old {

    protected HashMap<String, Provider_old> providers;

    public Providers_Old() {
        this.providers = new HashMap<String, Provider_old>();
    ...
    public Provider_old getOne(String id){
        return this.providers.get(id);
    }

    public ArrayList<Provider_old> getAllList() {
        return new ArrayList<Provider_old>(this.providers.values());
    }

    public void addOne(String id, String name, String info, String avatar) {
        this.providers.put(id, new Provider_old(id, name, info, avatar));
    }
